...
#define GL_BGRA_EXT                       0x80E1
    ...
    public:
        ...
        uint8_t* claim_mipmap_data(unsigned int index) {
            assert(!m_mipmaps.empty());
            assert(index < m_mipmaps.size());

            auto& surface = m_mipmaps[index];
            return surface.claim_data();
        }
    ...
    public:
        ...
        uint8_t* claim_mipmap_data(unsigned int index) {
            ...
            return m_images[0].claim_mipmap_data(index);
        }

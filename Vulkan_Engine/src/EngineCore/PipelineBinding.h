...
struct PipelineDescriptor : IRequireInitialization
{
	...
	const VkPipelineLayout getForwardPipelineLayout();
	const VkPipelineLayout getDepthOnlyPipelineLayout();

	bool hasGraphicsPipelineFor(const VkShader* shader) const;

#include "HardwarePresentation.h"

VkSurfaceFormatKHR HardwarePresentationDevice::chooseSwapSurfaceFormat() const
{
...
VkPresentModeKHR HardwarePresentationDevice::chooseSwapPresentMode() const
{
...
void HardwarePresentationDevice::querySwapChainSupport(VkPhysicalDevice device, VkSurfaceKHR surface, std::vector<VkSurfaceFormatKHR>& formats, std::vector<VkPresentModeKHR>& presentModes) const
{
...
int HardwarePresentationDevice::rateDeviceSuitability(VkPhysicalDevice device, VkSurfaceKHR surface) const
{
	int score = 0;
...
bool HardwarePresentationDevice::checkDeviceExtensionSupport(VkPhysicalDevice device, std::vector<const char*> requiredExtensions, std::string& unsupportedExtensionNames) const
{
	uint32_t extCount;
...
bool HardwarePresentationDevice::pickPhysicalDevice(VkInstance instance, VkSurfaceKHR surface)
{

...
PresentationDevice::PresentationDevice(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, const SDL_Window* windowPtr, std::optional<VulkanValidationLayers> validationLayers)
...
void PresentationDevice::release()
{
	vkDestroyCommandPool(m_vkdevice, m_commandPool, nullptr);
	vkDestroyDevice(m_vkdevice, nullptr);
}

bool PresentationDevice::createCommandPool()
{
...
bool PresentationDevice::createLogicalDevice(VkPhysicalDevice physicalDevice)
{

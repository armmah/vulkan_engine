...
bool Presentation::PresentationTarget::createGraphicsPipeline(VkDevice device, VertexBinding& vBinding, VkExtent2D scissorExtent, VkCullModeFlagBits faceCullingMode = VK_CULL_MODE_BACK_BIT)
{
